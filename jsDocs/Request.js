 ...
 * @constructs Request                      - https://www.javatpoint.com/expressjs-request
 * PROPERTIES * --------------------------------------------------------------------------------------------------------
 ...
 * METHODS * -----------------------------------------------------------------------------------------------------------
 * @property { function }   accepts         - Check whether the specified content types are acceptable.
 * @property { function }   get             - Returns the specified HTTP request header field.
 * @property { function }   is              - Is "Content-Type" HTTP header field matches the MIME type specified.
 * @property { function }   param           - This method is used to fetch the value of param name when present.
 */
